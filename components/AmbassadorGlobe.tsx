...
const DEMO_AMBASSADORS: Record<string, AmbassadorData> = {
  ...
  MEX: {
    ...
    shopName: 'Rebels 108',
    experience: 10,
    instagram: 'https://www.instagram.com/jordir108/?utm_source=ig_web_button_share_sheet',
  ...
  NLD: {
    ...
    experience: 10,
    instagram: 'https://www.instagram.com/the.debonhair?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==',
  ...
  PRT: {
    ...
    experience: 12,
    instagram: 'https://www.instagram.com/r.u.f.i.n.o?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==',
    location: 'Portugal',
  ...
  IDN: {
    ...
    experience: 9,
    instagram: 'https://www.instagram.com/fauzanandi?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==',
    location: 'Indonesia',
  ...
  USA: {
    ...
    experience: 15,
    instagram: 'https://www.instagram.com/cleverebel?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==',
  ...
  AUS: {
    ...
    experience: 7,
    instagram: 'https://www.instagram.com/slobisback?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==',
    location: 'Australia',
  ...
  SGP: {
    ...
    experience: 14,
    instagram: 'https://www.instagram.com/fazisml?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==',
    location: 'Singapore',
  ...
  SWE: {
    ...
    experience: 11,
    instagram: 'https://www.instagram.com/helenius.barb?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==',
    location: 'Sweden',
  ...
  ARG: {
    ...
    shopName: 'Alcatraz Shave Company',
    experience: 8,
    instagram: 'https://www.instagram.com/godoyivandavid?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==',
    location: 'Argentina',
    bio: 'David Godoy represents Blueprint in Argentina, bringing passion and precision to the craft.',
  },
  BRA: {
    name: 'Juliano Nunes',
    country: 'Brazil',
    ...
    shopName: 'Barbearia Galo Veio',
    experience: 10,
    instagram: 'https://www.instagram.com/jjulianonunes?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==',
    location: 'Brazil',
    bio: 'Juliano Nunes brings his creative workaholic energy and classic barbering expertise to Brazil.',
  },
  GRC: {
    ...
    experience: 5,
    instagram: 'https://www.instagram.com/outsidersbarbershop?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==',
    location: 'Athens, Greece',
    bio: 'Outsiders Barbershop is the home of traditional old school haircuts and hot towel shaves in Athens.',
  },
};
